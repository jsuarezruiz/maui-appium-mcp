    ...
    public class AndroidTools
    {
        ...
        public static byte[]? TakeScreenshot(string deviceSerial)
        {
            try
            {
                ...
                ProcessHelper.ExecuteCommand($"adb -s {deviceSerial} shell screencap -p {deviceTempFilePath}");
                ...
                ProcessHelper.ExecuteCommand($"adb pull {deviceTempFilePath} \"{localTempFilePath}\"");

                // Delete the screenshot file from the device
                ProcessHelper.ExecuteCommand($"adb shell rm {deviceTempFilePath}");
